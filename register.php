...
<!--<body style="background: url(./images/animation.gif)">-->
                    ...
                    <table align="center" width=350 height=230; style="font-family: 宋体; font-size: 25px;">
                        ...
                        <tr>
                            <td colspan="2" align="center">
                                <input type="button" name="zu" value="登录" onclick="location.href='index.php'" style="font-size: 17px;border-radius: 12px;" class="btn"/>
